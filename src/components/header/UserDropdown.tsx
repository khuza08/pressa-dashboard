  ...
  return (
    <div className="relative">
      <button
        ...
        <span className="block mr-1 font-medium text-theme-sm text-white/80">{displayName}</span>
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-white/60">
            {displayEmail}
          </span>
        </div>

        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-white/20">
          <li>
            <DropdownItem
              onItemClick={closeDropdown}
              tag="a"
              href="/profile"
              className="flex items-center gap-3 px-3 py-2 font-medium text-white/80 rounded-lg group text-theme-sm hover:bg-white/10 hover:text-white"
            >
              <svg
                className="fill-white/60 group-hover:fill-white dark:fill-white/60 dark:group-hover:fill-white"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
        ...
        <button
          ...
          className="flex items-center w-full gap-3 px-3 py-2 mt-3 font-medium text-white/80 rounded-lg group text-theme-sm hover:bg-white/10"
        >
          <svg
